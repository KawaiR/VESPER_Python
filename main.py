...
if __name__ == "__main__":
    ...
    if args.command == 'orig':
        ...
        #search_map_fft(mrc_N1, mrc_N2, TopN=topN, ang=angle_spacing, mode=modeVal, is_eval_mode=evalMode)
        search_map_fft_prob(mrc_N1_p1, mrc_N1_p2, mrc_N1_p3, mrc_N1_p4, mrc_N1,mrc_N2, mrc_N2_p1, mrc_N2_p2, mrc_N2_p3, mrc_N2_p4,alpha=1,ang=angle_spacing, mode="VecProduct")
