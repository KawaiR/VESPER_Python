...
if __name__ == "__main__":
    ...
    orig.add_argument('-g', type=float, default=16.0, help='Bandwidth of the Gaussian filter def=16.0, sigma = 0.5*[value entered]')
    ...
    if args.command == 'orig':
        ...
        print(objA, objB, probA, probB, threshold1, threshold2, bandwidth, voxel_spacing, angle_spacing, topN, showPdb, modeVal, evalMode)
        ...
        mrc_list = [mrc_N1, mrc_N2, mrc_N1_p1, mrc_N1_p2, mrc_N1_p3, mrc_N1_p4, mrc_N2_p1, mrc_N2_p2, mrc_N2_p3, mrc_N2_p4]
        max_dim = np.max((mrc_N1.xdim, mrc_N2.xdim, mrc_N2_p1.xdim, mrc_N2_p2.xdim, mrc_N2_p3.xdim, mrc_N2_p4.xdim, mrc_N1_p1.xdim, mrc_N1_p2.xdim, mrc_N1_p3.xdim, mrc_N1_p4.xdim))
        ...
        for mrc in mrc_list:
            if mrc.xdim != max_dim:
                ...
                mrc.orig["x"] = mrc.cent[0] - 0.5 * voxel_spacing * mrc.xdim
                mrc.orig["y"] = mrc.cent[1] - 0.5 * voxel_spacing * mrc.xdim
                mrc.orig["z"] = mrc.cent[2] - 0.5 * voxel_spacing * mrc.xdim
        ...
        mrc_N1_p1 = fastVEC_prob(mrc1_p1, mrc_N1_p1)
        mrc_N1_p2 = fastVEC_prob(mrc1_p2, mrc_N1_p2)
        mrc_N1_p3 = fastVEC_prob(mrc1_p3, mrc_N1_p3)
        mrc_N1_p4 = fastVEC_prob(mrc1_p4, mrc_N1_p4)



        mrc_N2 = fastVEC(mrc2, mrc_N2)
        mrc_N2_p1 = fastVEC_prob(mrc2_p1, mrc_N2_p1)
        mrc_N2_p2 = fastVEC_prob(mrc2_p2, mrc_N2_p2)
        mrc_N2_p3 = fastVEC_prob(mrc2_p3, mrc_N2_p3)
        mrc_N2_p4 = fastVEC_prob(mrc2_p4, mrc_N2_p4)
                
        #search_map_fft(mrc_N1, mrc_N2, TopN=topN, ang=angle_spacing, mode=modeVal, is_eval_mode=evalMode)
        search_map_fft_prob(mrc_N1_p1, mrc_N1_p2, mrc_N1_p3, mrc_N1_p4, mrc_N1,mrc_N2, mrc_N2_p1, mrc_N2_p2, mrc_N2_p3, mrc_N2_p4, ang=angle_spacing, mode="VecProduct")
